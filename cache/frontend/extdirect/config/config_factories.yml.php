...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Users/felipedelpozo/Sites/sample/log/frontend_extdirect.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Users/felipedelpozo/Sites/sample/cache/frontend/extdirect/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Users/felipedelpozo/Sites/sample/apps/frontend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_controller', 'dsExtDirectController');
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Users/felipedelpozo/Sites/sample/cache/frontend/extdirect/template',
  'lifetime' => 86400,
  'prefix' => '/Users/felipedelpozo/Sites/sample/apps/frontend/template',
)));
